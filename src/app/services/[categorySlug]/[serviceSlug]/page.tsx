      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid md:grid-cols-[1fr,1.2fr] gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex flex-col">
            <Badge variant="secondary" className="mb-6 w-fit bg-red-50 text-red-600 hover:bg-red-100 px-4 py-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mb-8 md:mb-10">
              {service.details.slice(0, 5).map((detail, index) => (
                <div key={index} className="flex items-start gap-3">
                  <div className="rounded-full bg-red-50 p-1.5 mt-0.5 shrink-0">
                    <Check className="h-3.5 w-3.5 text-red-600 stroke-[2.5]" />
                  </div>
                  <span className="text-sm md:text-base text-foreground leading-relaxed">{detail}</span>
                </div>
              ))}
            </div>

            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-auto">
              <Button asChild size="lg" className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white shadow-md">
          ...
          <div className="order-first md:order-last">
            <div className="aspect-[4/3] md:aspect-video w-full overflow-hidden rounded-2xl border shadow-xl">
              <Image
        ...
        <div className="mt-12 md:mt-16">
          <Card className="border-2 bg-gradient-to-br from-red-50 to-white">
            <CardContent className="p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold font-headline text-primary mb-6">Why Choose Prime Home Club</h2>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-red-600 mt-0.5 shrink-0" />
                  <div>
          ...
          <Card className="border-2">
            <CardContent className="p-6 md:p-8">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <p><strong className="text-foreground">Phone:</strong> <a href="tel:+918858585559" className="text-red-600 hover:underline">+91 88585 85559</a></p>
                <p><strong className="text-foreground">Email:</strong> <a href="mailto:info@primehomeclub.com" className="text-red-600 hover:underline">info@primehomeclub.com</a></p>
